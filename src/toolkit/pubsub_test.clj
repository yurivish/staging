...
(deftest valid-pub-token
  (is (true?  (ps/valid-pub-token? "foo")))
  (is (true?  (ps/valid-pub-token? "foo_bar-baz")))
  (is (false? (ps/valid-pub-token? "foo.bar"))  "dots disallowed")
  (is (false? (ps/valid-pub-token? "*")))
  (is (false? (ps/valid-pub-token? ">")))
  (is (false? (ps/valid-pub-token? "")))
  (is (false? (ps/valid-pub-token? nil))))
